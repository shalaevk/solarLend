   ...
   return <footer className={cl.footer}>
      ...
      <div className={cl.footerCopy}>
         ...
         <div className={cl.copyRight}>
            ...
            <p>{props.lang === "uk" ? <span className="prPolicy" onClick={props.showModal}> {props.lang === "uk" ? "Політика конфіденційності" : "Политика конфиденциальности"}</span> : <span onClick={props.showModal}> Политика конфиденциальности</span>}</p>
         </div>
      </div>
   </footer>
}
