...
const Head = (props) => {
    ...
    return (
        ...
        >
            ...
            <meta property="og:image:secure_url" content="https://solarland.s-tet.top/wp-content/uploads/2021/07/solar-logo.png" />
            <meta property="og:image:url" content="https://solarland.s-tet.top/wp-content/uploads/2021/07/solar-logo.png" />
        </Helmet>
    )
}
